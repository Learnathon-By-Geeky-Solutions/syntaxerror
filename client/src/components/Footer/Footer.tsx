        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              Your trusted partner for fresh, organic produce delivered right to your doorstep. We believe in quality, sustainability, and healthy living.
            </p>
          ...
          <div>
            ...
            <ul className="grid grid-cols-1 gap-3">
              {["About Us", "Our Products", "Special Offers", "Testimonials", "Contact Us"].map(
                (item) => (
                  <li key={item}>
                    <Link
                      href="#"
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-600">
              © {currentYear} <span className="text-green-600 font-medium">iKrishak</span>. All rights reserved.
            </p>
